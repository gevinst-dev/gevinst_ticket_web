        ...
        <div class="col-12">
            <div class="form-group">
                ...
                <select name="language" class="form-select" id="language">
                    @foreach (App\Models\Utility::flagOfCountry() as $lang)
...
<script>
    function copyText() {
        ...
        if (input > 0) {
            ...
            if ($('textarea[name=' + selected + ']').hasClass('ckdescription')) {
                $.each($('textarea[name=' + selected + ']'), function(i, editor) {
                    if ($(this).attr('id') != undefined) {
                        try {
                            CKEDITOR.instances[$(this).attr('id')].setData(copied);
                        } catch (err) {
        ...
        if (input > 0) {
            ...
            if ($('textarea[name=' + selected + ']').hasClass('ckdescription')) {
                $.each($('textarea[name=' + selected + ']'), function(i, editor) {
                    if ($(this).attr('id') != undefined) {
                        try {
                            CKEDITOR.instances[$(this).attr('id')].setData(selectedText);
                        } catch (err) {
